<template lang="pug">
.entity-list-item-wrapper.context-list-item-wrapper
  ...
  .entity-list-item-actions(v-if='!confirming_destroy && showing_actions')
    .ui.four.column.grid
      .column
        router-link.ui.basic.fluid.green.icon.button(:to='context.path()')
          i.eye.icon
  ...
  router-link.entity-list-item.context-list-item(v-if='!confirming_destroy && !showing_actions'
                                                 :to='context.path()')
