<template lang="pug">
.entity-list-item-wrapper.goal-list-item-wrapper
  ...
  .action-menu(v-if='!confirming_destroy && showing_actions')
    shared-link.action-menu-item(:to='goal.path()')
       i.eye.green.icon
  ...
  shared-link.entity-list-item.goal-list-item(v-if='!confirming_destroy && !showing_actions'
                                              :to='goal.path()')
