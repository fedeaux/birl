<template lang="pug">
.session-progression-list-item-wrapper
  ...
  .action-menu(v-if='!confirming_destroy && showing_actions')
    shared-link.action-menu-item(:to='session_progression.path()')
       i.eye.green.icon
  ...
  shared-link.entity-list-item.session-progression-list-item(v-if='!confirming_destroy && !showing_actions'
