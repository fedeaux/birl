<template lang="pug">
.entity-list-item-wrapper.vocabulary-list-item-wrapper
  ...
  .entity-list-item-actions(v-if='!confirming_destroy && showing_actions')
    .ui.four.column.grid
      .column
        router-link.ui.basic.fluid.green.icon.button(:to='vocabulary.path()')
          i.eye.icon
  ...
  router-link.entity-list-item.vocabulary-list-item(v-if='!confirming_destroy && !showing_actions'
                                                    :to='vocabulary.path()')
