<template lang="pug">
.entity-list-item-wrapper.timelog-list-item-wrapper
  ...
  .action-menu(v-if='!confirming_destroy && showing_actions')
    shared-link.action-menu-item(:to='timelog.path()')
       i.eye.green.icon
  ...
  shared-link.entity-list-item.timelog-list-item(v-if='!confirming_destroy && !showing_actions'
                                                 :to='timelog.path()')
