<template lang="pug">
.entity-list-item-wrapper.goal-entry-list-item-wrapper
  ...
  .action-menu(v-if='!confirming_destroy && showing_actions')
    shared-link.action-menu-item(:to='goal_entry.path()')
       i.eye.green.icon
  ...
  shared-link.entity-list-item.goal-entry-list-item(v-if='!confirming_destroy && !showing_actions'
                                                    :to='goal_entry.path()')
