<template lang="pug">
.tag-taggable-list-item-wrapper
  ...
  .action-menu(v-if='!confirming_destroy && showing_actions')
    shared-link.action-menu-item(:to='tag_taggable.path()')
       i.eye.green.icon
  ...
  shared-link.entity-list-item.tag-taggable-list-item(v-if='!confirming_destroy && !showing_actions'
